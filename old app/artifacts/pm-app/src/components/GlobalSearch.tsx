...
const ALL_PAGES: SearchEntry[] = [
  ...
  { path: "/civil-drawing-ai",     label: "Civil Drawing AI",  icon: Building2,          group: "Design & Engineering",keywords: "civil drawing ai building structure" },
  ...
  { path: "/site-db",              label: "Site DB Viewer",    icon: Database,           group: "Monitoring",          keywords: "site db database viewer" },
  { path: "/site-db/analyze",      label: "Plant Analytics",   icon: Sparkles,           group: "Monitoring",          keywords: "site db analytics ai analyze" },
