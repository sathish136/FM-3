...
============================================
Run:  python app.py
API:  http://localhost:5501/api/<section_key>
...
@app.route("/api/logistics/po_pending")
def logistics_po_pending():
    """
    PO made — logistics entry pending.
    Row format:
    {
        "po_no": "PO-2026001",
...
@app.route("/api/logistics/supplier_delay")
def logistics_supplier_delay():
    """
    Supplier delay.
    Row format:
    {
...
@app.route("/api/logistics/material_delay")
def logistics_material_delay():
    """
    Material delay.
    Row format:
    {
        "description": "HDPE Pipe 200mm",
        "po_no": "PO-2026003",
        "supplier": "Ion Exchange",
        "delay_days": 8
    }
    """
    data = [
...
@app.route("/api/logistics/on_time")
def logistics_on_time():
    """
    On-time deliveries.
    Row format:
    {
...
@app.route("/api/logistics/gprs_pending")
def logistics_gprs_pending():
    """
    GPRS tracking not entered.
    Row format:
    {
        "po_no": "PO-2026005",
        "tracking": "—",
        "expected_delivery": "03-04-2026"
    }
    """
    data = [
        # TODO: DB query
