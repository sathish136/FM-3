...
import MeetingDiscussion from "@/pages/MeetingDiscussion";
...
import LeadFollowUpHistory from "@/pages/LeadFollowUpHistory";
...
import PLCProjectDailyStatus from "@/pages/PLCProjectDailyStatus";
...
function ProtectedRoutes() {
  ...
  return (
    <Switch>
      ...
      <Route path="/meeting-discussion" component={MeetingDiscussion} />
      ...
      <Route path="/proposal-library" component={ProposalLibrary} />
      ...
      <Route path="/sales-dashboard/lead/:name" component={LeadFollowUpHistory} />
      ...
      <Route path="/plc-automation/project-daily-status" component={PLCProjectDailyStatus}  />
