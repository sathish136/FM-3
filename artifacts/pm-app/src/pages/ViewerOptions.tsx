...
function ProjectDropdown({
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute top-full left-0 mt-1.5 z-50 w-80 bg-[#1a1a2e] border border-white/10 rounded-xl shadow-2xl overflow-hidden">
    ...
    <Layout>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Browse and view 3D design files by project.</p>
        </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground max-w-sm mx-auto">
                {selectedProject
                  ...
                  : "Select a project above to browse its 3D design files."}
              </p>
            </div>
