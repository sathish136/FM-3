            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h1 className="text-2xl font-extrabold text-slate-900">Plant Observation Report</h1>
                  <span className="px-2 py-0.5 rounded-md bg-indigo-100 text-indigo-700 text-[11px] font-bold uppercase tracking-wide">{plant.typeLabel}</span>
                </div>
                <div className="text-sm text-slate-500 mt-0.5 flex items-center gap-2 flex-wrap">
                  <span className="font-semibold text-slate-700">{dbLabel}</span>
                  <span>·</span>
                  <span>{table}</span>
                  <span>·</span>
                  <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" />{PERIOD_LABEL[period]}</span>
                  <span>·</span>
  ...
  return (
    <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      <header className="px-6 py-4 border-b border-slate-100 flex items-center gap-3">
        <div className={`w-9 h-9 rounded-lg bg-gradient-to-br ${accents[accent]} flex items-center justify-center shadow-sm`}>
