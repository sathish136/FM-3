  ...
  },
  {
    ...
    moduleRoles: JSON.stringify(Object.fromEntries([
      ...
      ...["purchase-order","purchase-orders","purchase-dashboard","stores-dashboard","logistics-dashboard","process-proposal",
         ...
         "plc-site-calls","plc-service-reports","plc-programs","plc-hmi-programs","plc-pid-design","plc-instruments","plc-tags","plc-panel-inspection","plc-support-tickets","plc-device-config","plc-network-architecture",
         "om-chemical-consumption","om-lab-reports","om-site-performance"].map(k => [k, "read"]),
  ...
  },
  {
    ...
    moduleRoles: JSON.stringify(Object.fromEntries([
      ...["dashboard","calendar","tasks","design-3d","pid","nesting","project-drawings","email","chat",
         "plc-site-calls","plc-service-reports","plc-programs","plc-hmi-programs","plc-pid-design","plc-instruments","plc-tags","plc-panel-inspection","plc-support-tickets","plc-device-config","plc-network-architecture",
         "om-chemical-consumption","om-lab-reports","om-site-performance"].map(k => [k, "write"]),
