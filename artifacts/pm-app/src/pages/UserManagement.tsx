  ...
  },
  {
    ...
    moduleRoles: JSON.stringify(Object.fromEntries([
      ...
      ...["purchase-order","purchase-orders","purchase-dashboard","stores-dashboard","logistics-dashboard","process-proposal",
         ...
         "plc-site-calls","plc-service-reports","plc-programs","plc-hmi-programs","plc-pid-design","plc-instruments","plc-tags","plc-panel-inspection"].map(k => [k, "read"]),
  ...
  },
  {
    ...
    moduleRoles: JSON.stringify(Object.fromEntries([
      ...["dashboard","calendar","tasks","design-3d","pid","nesting","project-drawings","email","chat",
         "plc-site-calls","plc-service-reports","plc-programs","plc-hmi-programs","plc-pid-design","plc-instruments","plc-tags","plc-panel-inspection"].map(k => [k, "write"]),
  ...
  },
  {
    ...
    moduleRoles: JSON.stringify(Object.fromEntries([
      ...
      ...["task-management","team-pulse","team-reporting","ip-call-logs","ip-call-logs-hr","ip-call-logs-project","ip-call-logs-purchase",
         ...
         "plc-tags","plc-panel-inspection","material-request","purchase-order","purchase-orders","purchase-dashboard","stores-dashboard",
  ...
  },
  {
    ...
    moduleRoles: JSON.stringify(Object.fromEntries([
      ...
      ...["task-management","team-pulse","team-reporting","ip-call-logs","ip-call-logs-hr","ip-call-logs-project","ip-call-logs-purchase",
         ...
         "plc-pid-design","plc-instruments","plc-tags","plc-panel-inspection","marketing","leads","campaigns","vc-card-scanner","plant-enquiry",
